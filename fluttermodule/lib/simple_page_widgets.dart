...
class _FirstRouteWidgetState extends State<FirstRouteWidget> {
  ...
  Future<dynamic> _getAppVersion() async {
    ...
    try {
      final String result = await Flutterplugin.appVersion;;
      print('getAppVersion:' + result);
      setState(() {
        _appVersion = result;
      });
    } on PlatformException catch (e) {
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            RaisedButton(
              child: Text('Get platform version by method channel:' + _platformVersion),
              onPressed: () => _getPlatformVersion(),
            ),
            RaisedButton(
              child: Text('Get app version by plugin:' + _appVersion),
            ...
            children: <Widget>[
              ...
              InkWell(
                child: Container(
                    ...
                    color: Colors.yellow,
                    child: Text(
                      'get platform version by method channel:' + _platformVersion,
                      style: TextStyle(fontSize: 22.0, color: Colors.black),
                    )),
              ...
              InkWell(
                child: Container(
                    ...
                    color: Colors.yellow,
                    child: Text(
                      'get app version by method channel:' + _appVersion,
                      style: TextStyle(fontSize: 22.0, color: Colors.black),
                    )),
                onTap: () => _getAppVersion(),
              ),
            ],
          ),
        ),
